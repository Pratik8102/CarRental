...
<title>Le Chalo | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>₹ <?php echo htmlentities($result->PricePerDay)*81.94;?> </p>Per Day
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">₹ <?php echo htmlentities($result->PricePerDay)*81.94;?></p>
